...
var stage01 = new Phaser.Scene("stage01");
...
stage01.preload = function () {
  this.load.image("divisao", "./assets/stage01/division.png");
  this.load.image("dica", "./assets/stage01/object-pagegame-dicas.png");
  this.load.image("entrada", "./assets/stage01/object-pagegame-entrada.png");
  this.load.image("map", "./assets/stage01/fundo-pagegame-fundo01.png");
  this.load.image("pagedica01", "./assets/stage01/subpage-pagegame-dica01.png");
  this.load.image("pagedica02", "./assets/stage01/subpage-pagegame-dica02.png");
  this.load.image("pagedica03", "./assets/stage01/subpage-pagegame-dica03.png");
  this.load.image("pagedica04", "./assets/stage01/subpage-pagegame-dica04.png");
  this.load.image("pc", "./assets/stage01/object-pagegame-pc.png");
  this.load.image("status01", "./assets/stage01/player1-pagegame-status.png");
  this.load.image("status02", "./assets/stage01/player2-pagegame-status.png");
  this.load.image("opcao01", "./assets/stage01/button-pc-opcao01.png");
  this.load.image("opcao02", "./assets/stage01/button-pc-opcao02.png");
  this.load.image("opcao03", "./assets/stage01/button-pc-opcao03.png");

  this.load.spritesheet("saida", "./assets/stage01/object-pagegame-saida.png", {
    frameWidth: 271.8523,
    frameHeight: 64.8913,
  });

  this.load.spritesheet("player1", "./assets/stage01/player1.png", {
    frameWidth: 120,
    frameHeight: 120,
  });

  this.load.spritesheet("player2", "./assets/stage01/player2.png", {
    frameWidth: 120,
    frameHeight: 120,
  });

  this.load.spritesheet("closestage", "./assets/stage01/button-pagegame-close.png", {
    frameWidth: 242.1196,
    frameHeight: 80.7065,
  });
};

stage01.create = function () {
...
stage01.update = function () {
  if (gameOver) {this.scene.stop()}
  if (gameOver) {this.scene.start(stage02)}
